...
const EditableOrderCardAdmin = ({ price, type, itemName, quantity: initialQuantity, unit, orderItem, onQuantityChange ,onRemove }) => {
  ...
  return (
    <View style={styles.card}>
      <TouchableOpacity style={styles.deleteBtn} onPress={() => onRemove(orderItem?.item?.id)}>
...
export default EditableOrderCardAdmin;
